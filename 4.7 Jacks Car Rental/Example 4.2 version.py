...
class CarRental(object):
    def __init__(self):
        ...
        self.gamma = 0.9
        self.max_rental = 10
        self.modelSaveFile = './model_save/4.2/model.pkl'
    ...
    def visualize(self, count):
        ...
        # plt.show()
        fig.savefig("./figures/4.2/policy" + str(count) + ".png", bbox_inches='tight')
...
if __name__ == "__main__":
    # make the directory
    if not os.path.exists("./figures/4.2/"):
        os.makedirs("./figures/4.2")
    if not os.path.exists("./model_save/4.2/"):
        os.makedirs("./model_save/4.2")
